...
# 코딩 스타일
<p>해당 내용은 팀을 구성하는 개발자 전원이 동일한 서식의 코드를 작성함으로써 프로젝트의 가독성과 유지 보수성을 향상하는 것을 목적으로 한다.</p>
<div>
  <b>조건</b>
...
<div>
  ...
  <div>
    <b>예외 - DB 관련 기능</b>
    <p>사용 조건으로, 양식을 두 번 제출할 필요가 있는 과정에서 중간 단계를 테스팅할 때 사용한다.</p>
    <p>사용 방법으로, 첫 번째 구분을 다음의 것으로 한다는 점 이외에는 기본 구문 사용법과 동일하게 사용하면 된다.</p>
    <code>search + 활용되는 대상 식별자</code>
  </div>
</div>
<br>
