...
public final class WordCamel {
    ...
    public static final String INDUSTRY_CATEGORY_NUMBER = "industryCategoryNumber";
    public static final String MAPPED_ARTICLE_NUMBERS = "mappedArticleNumbers";
