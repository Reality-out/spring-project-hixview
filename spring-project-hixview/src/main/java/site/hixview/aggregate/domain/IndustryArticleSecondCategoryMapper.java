...
public class IndustryArticleSecondCategoryMapper implements ConvertibleToDto<IndustryArticleSecondCategoryMapperDto> {
    ...
    public static final class IndustryArticleSecondCategoryMapperBuilder {
        ...
        public IndustryArticleSecondCategoryMapper.IndustryArticleSecondCategoryMapperBuilder mapper(final IndustryArticleSecondCategoryMapper mapper) {
        ...
        public IndustryArticleSecondCategoryMapper.IndustryArticleSecondCategoryMapperBuilder mapperDto(final IndustryArticleSecondCategoryMapperDto mapperDto) {
