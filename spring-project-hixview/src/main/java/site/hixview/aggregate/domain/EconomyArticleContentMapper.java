...
public class EconomyArticleContentMapper implements ConvertibleToDto<EconomyArticleContentMapperDto> {
    ...
    public static final class EconomyArticleContentMapperBuilder {
        ...
        public EconomyArticleContentMapperBuilder mapper(final EconomyArticleContentMapper mapper) {
        ...
        public EconomyArticleContentMapperBuilder mapperDto(final EconomyArticleContentMapperDto mapperDto) {
