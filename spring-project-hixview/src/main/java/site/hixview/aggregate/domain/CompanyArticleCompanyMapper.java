...
public class CompanyArticleCompanyMapper implements ConvertibleToDto<CompanyArticleCompanyMapperDto> {
    ...
    public static final class CompanyArticleCompanyMapperBuilder {
        ...
        public CompanyArticleCompanyMapper.CompanyArticleCompanyMapperBuilder mapper(final CompanyArticleCompanyMapper mapper) {
        ...
        public CompanyArticleCompanyMapper.CompanyArticleCompanyMapperBuilder mapperDto(final CompanyArticleCompanyMapperDto mapperDto) {
