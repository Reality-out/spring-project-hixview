...
public class BlogPostArticleMapper implements ConvertibleToDto<BlogPostArticleMapperDto> {
    ...
    public static final class BlogPostArticleMapperBuilder {
        ...
        public BlogPostArticleMapperBuilder mapper(final BlogPostArticleMapper mapper) {
        ...
        public BlogPostArticleMapperBuilder mapperDto(final BlogPostArticleMapperDto mapperDto) {
