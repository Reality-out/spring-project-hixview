...
public final class ExceptionName {
    ...
    public static final String NOT_FOUND_BLOG_POST_ERROR = "notFoundBlogPostError";
    ...
    public static final String NOT_FOUND_ECONOMY_ARTICLE_ERROR = "notFoundEconomyArticleError";
    ...
    public static final String NOT_FOUND_SUBJECT_COUNTRY_ERROR = "notFoundSubjectCountryError";
