...
@Component
public class BlogPostEntityMapperImpl extends BlogPostEntityMapper {

    @Override
    public BlogPostEntity toBlogPostEntity(BlogPost blogPost) {
        if ( blogPost == null ) {
            return null;
        }
    ...
    @Override
    public BlogPost toBlogPost(BlogPostEntity blogPostEntity) {
