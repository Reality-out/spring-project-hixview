...
@Component
public class EconomyArticleEntityMapperImpl extends EconomyArticleEntityMapper {

    @Override
    public EconomyArticleEntity toEconomyArticleEntity(EconomyArticle economyArticle) {
    ...
    @Override
    public EconomyArticle toEconomyArticle(EconomyArticleEntity economyArticleEntity) {
