...
public interface CompanyArticleTestUtils extends ArticleTestUtils, PressTestUtils {
    /**
     * Create
     */
    default CompanyArticleEntity createCompanyArticle() {
    ...
    default CompanyArticleEntity createAnotherCompanyArticle() {
        return CompanyArticleEntity.builder()
