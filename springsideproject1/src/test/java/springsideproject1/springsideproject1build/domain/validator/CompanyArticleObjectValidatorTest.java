...
@Transactional
public class CompanyArticleObjectValidatorTest implements CompanyArticleTestUtils, CompanyTestUtils {
    ...
    @Autowired
    public CompanyArticleObjectValidatorTest(DataSource dataSource) {
